            ...
            <div class="mb-2 row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="namabarang" class="form-control @error('namabarang') is-invalid @enderror"
                        value="{{ old('namabarang') }}" autofocus>
                    @error('namabarang')
            ...
            <div class="mb-2 row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="tahunbeli" inputmode="numeric"
                        class="form-control @error('tahunbeli') is-invalid @enderror" value="{{ old('tahunbeli') }}">
                    @error('tahunbeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="hargabeli" inputmode="numeric"
                        class="form-control @error('hargabeli') is-invalid @enderror" value="{{ old('hargabeli') }}">
                    @error('hargabeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <textarea name="spesifikasi" class="form-control" @error('spesifikasi') is-invalid
                        @enderror">{{ old('spesifikasi') }}</textarea>
                    @error('spesifikasi')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
