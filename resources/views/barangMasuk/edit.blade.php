...
<div class="card-body">
    ...
    <div class="mb-2 row">
        <form action="{{  url('barang-masuk/'. $id = $barangMasuk -> id) }}" method="POST">
            ...
            <div class="mb-2 row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="namabarang" class="form-control @error('namabarang') is-invalid @enderror"
                        value="{{ old('namabarang', $barangMasuk -> nama_barang) }}" autofocus>
                    @error('namabarang')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kodebarang" class="form-control @error('kodebarang') is-invalid @enderror"
                        value="{{ old('kodebarang', $barangMasuk -> kode_barang) }}">
                    @error('kodebarang')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-2 row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="merkbarang" class="form-control @error('merkbarang') is-invalid @enderror"
                        value="{{ old('merkbarang', $barangMasuk -> merk) }}">
                    @error('merkbarang')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" name="stokmasuk"
                                class="form-control @error('stokmasuk') is-invalid @enderror"
                                value="{{ old('stokmasuk', optional($barangMasuk->barangstoks->first())->stok_masuk) }}">
                            @error('stokmasuk')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-6">
                            <label for="pengguna" class="form-label">Satuan</label>
                            <select name="satuan" class="form-control">
                                <option value="{{ optional($barangMasuk->barangstoks->first())->satuan }}">{{ optional($barangMasuk->barangstoks->first())->satuan }}</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="ukuran" class="form-control @error('ukuran') is-invalid @enderror"
                        value="{{ old('ukuran', $barangMasuk -> ukuran) }}">
                    @error('ukuran')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="bahan" class="form-control @error('bahan') is-invalid @enderror"
                        value="{{ old('bahan', $barangMasuk -> bahan) }}">
                    @error('bahan')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-2 row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="tahunbeli" inputmode="numeric"
                        class="form-control @error('tahunbeli') is-invalid @enderror"
                        value="{{ old('tahunbeli', $barangMasuk -> tahun_beli) }}">
                    @error('tahunbeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="hargabeli" inputmode="numeric"
                        class="form-control @error('hargabeli') is-invalid @enderror"
                        value="{{ old('hargabeli', $barangMasuk -> harga_beli) }}">
                    @error('hargabeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <textarea name="spesifikasi" class="form-control" @error('spesifikasi') is-invalid
                        @enderror">{{ old('spesifikasi', $barangMasuk -> spesifikasi) }}</textarea>
                    @error('spesifikasi')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <textarea name="keterangan" class="form-control" @error('keterangan') is-invalid
                        @enderror">{{ old('keterangan', $barangMasuk -> keterangan) }}</textarea>
                    @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-2 row">
                <div class="col-md-4">
                    ...
                    <select name="kategori" id="" class="form-control">
                        <option value="{{ $barangMasuk->kategori->id }}">{{ $barangMasuk->kategori->nama_kategori }}
                        </option>
                ...
                <div class="col-md-4">
                    ...
                    <select name="kondisi" class="form-control">
                        <option value="{{ $barangMasuk->kondisi->id }}">{{ $barangMasuk->kondisi->nama_kondisi }}
                        </option>
        ...
        <p class="mt-5" style="color: red; font-size: 12px">*kolom Ukuran, Bahan, Tahun Beli, Spesifikasi, Keterangan
            bisa dikosongkan</p>
    </div>
    @endsection