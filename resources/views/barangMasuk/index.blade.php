...
<div class="card-body" style="background-color: rgb(255, 255, 255)">
    <div class="">
        <div class="mb-sm-0 row">
            <div class="col-md-4">
                <h5 class="card-title fw-semibold mb-3">Barang Masuk</h5>
    ...
    <div class="table-responsive">
        <table id="tabeldataBarangMasuk" class="table table-striped table-hover mt-5"
            data-url="{{ route('barangMasuk.index') }}">
            <thead>
                <tr>
