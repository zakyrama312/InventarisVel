        ...
        <form action="{{ url('barang-masuk') }}" method="post">
            ...
            <div class="mb-2 row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="namabarang" class="form-control @error('namabarang') is-invalid @enderror"  value="{{ old('namabarang') }}" autofocus>
                    @error('namabarang')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kodebarang" class="form-control @error('kodebarang') is-invalid @enderror"  value="{{ old('kodebarang') }}">
                    @error('kodebarang')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-2 row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="merkbarang" class="form-control @error('merkbarang') is-invalid @enderror"  value="{{ old('merkbarang') }}">
                    @error('merkbarang')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="stokmasuk" class="form-control @error('stokmasuk') is-invalid @enderror"  value="{{ old('stokmasuk') }}">
                    @error('stokmasuk')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="bahan" class="form-control @error('bahan') is-invalid @enderror"  value="{{ old('bahan') }}">
                    @error('bahan')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-2 row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="tahunbeli" inputmode="numeric" class="form-control @error('tahunbeli') is-invalid @enderror"  value="{{ old('tahunbeli') }}">
                    @error('tahunbeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="hargabeli" inputmode="numeric" class="form-control @error('hargabeli') is-invalid @enderror"  value="{{ old('hargabeli') }}">
                    @error('hargabeli')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <textarea name="spesifikasi" class="form-control" @error('spesifikasi') is-invalid @enderror" >{{ old('spesifikasi') }}</textarea>
                    @error('spesifikasi')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
